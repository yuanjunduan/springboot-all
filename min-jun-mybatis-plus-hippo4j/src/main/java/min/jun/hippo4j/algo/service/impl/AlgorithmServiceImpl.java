...
import min.jun.hippo4j.algo.domain.mapstruct.AlgorithmMapstruct;
import min.jun.hippo4j.algo.domain.vo.AlgorithmVo;
import min.jun.hippo4j.algo.mapper.AlgorithmMapper;
import min.jun.hippo4j.algo.service.AlgorithmService;
import min.jun.hippo4j.utils.PageResult;
...
//        boolean b = saveBatch(objects, 5);
    ...
    public void update(Algorithm algorithm) {
        ...
        updateWrapper.set(Algorithm::getAlgoDescribe, algorithm.getAlgoDescribe()).eq(Algorithm::getId, algorithm.getId());
